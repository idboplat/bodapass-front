...
interface OpenOrderStatusProps {
  page: TClientPage;
  session: Session;
  dto: TOpenOrderStatusDto;
}

/** 주문 - 미체결내역 */
export default function Client({ page, session, dto }: OpenOrderStatusProps) {
                ...
                {/* <Calendar_box openPop={openCalendar}>
                  ...
                  <div className="cal-popup">
                    <div className="popup-head">
                      ...
                      <a className="close" onClick={() => setOpenCalendar(false)}>
                        닫기
                      </a>
                    </div>
                      ...
                      <div className="cal-body">
                        <table className="cal-list-start">
                          ...
                          <tbody>
                            ...
                            <tr>
                              <td className="sun today">
                                <a className="date">14</a>
                              </td>
                              <td>
                                <a className="date">15</a>
                              </td>
                              <td>
                                <a className="date">16</a>
                              </td>
                              <td>
                                <a className="date">17</a>
                              </td>
                              <td>
                                <a className="date">18</a>
                              </td>
                              <td>
                                <a className="date">19</a>
                              </td>
                              <td>
                                <a className="date">20</a>
                              </td>
                            </tr>
                            <tr>
                              <td className="sun">
                                <a className="date">21</a>
                              </td>
                              <td>
                                <a className="date">22</a>
                              </td>
                              <td>
                                <a className="date">23</a>
                              </td>
                              <td>
                                <a className="date">24</a>
                              </td>
                              <td>
                                <a className="date">25</a>
                              </td>
                              <td>
                                <a className="date">26</a>
                              </td>
                              <td>
                                <a className="date">27</a>
                              </td>
                            </tr>
                            <tr>
                              <td className="sun">
                                <a className="date">28</a>
                              </td>
                              <td>
                                <a className="date">29</a>
                              </td>
                              <td>
                                <a className="date">30</a>
                              </td>
                              <td></td>
                              <td></td>
                              <td></td>
                        ...
                        <table className="cal-list-end">
                          ...
                          <tbody>
                            <tr>
                              <td></td>
                              <td>
                                <a className="date">1</a>
                              </td>
                              <td>
                                <a className="date">2</a>
                              </td>
                              <td>
                                <a className="date">3</a>
                              </td>
                              <td>
                                <a className="date">4</a>
                              </td>
                              <td>
                                <a className="date">5</a>
                              </td>
                              <td>
                                <a className="date">6</a>
                              </td>
                            </tr>
                            <tr>
                              <td className="sun">
                                <a className="date">7</a>
                              </td>
                              <td>
                                <a className="date">8</a>
                              </td>
                              <td>
                                <a className="date">9</a>
                              </td>
                              <td>
                                <a className="date">10</a>
                              </td>
                              <td>
                                <a className="date">11</a>
                              </td>
                              <td>
                                <a className="date">12</a>
                              </td>
                              <td>
                                <a className="date">13</a>
                              </td>
                            </tr>
                            <tr>
                              <td className="sun">
              ...
              <div>
                <Select_box openType={openType}>
                  <button type="button" onClick={() => setOpenType(!openType)}>
                    <p id="select-button">타입1</p>
                  </button>
                  <div>
                    <dl>
                      <dd className={selectedType === 0 ? "active" : ""}>
                        <a onClick={() => setSelectedType(0)}>
                          <p>타입1</p>
                        </a>
                      </dd>
                      <dd className={selectedType === 1 ? "active" : ""}>
                        <a onClick={() => setSelectedType(1)}>
                          <p>타입2</p>
                        </a>
                      </dd>
                    </dl>
