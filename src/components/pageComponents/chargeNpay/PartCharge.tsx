...
interface PartChargeProps {
  session : Session;

}

/** 입금 */
export default function PartCharge(
  { session }: PartChargeProps) {
    ...
    return (
      ...
      <Write_box>
        <ul>
          <li>
						<strong>금일 입금 금액</strong>
						<div>
              <Input_box>
                <input style={{textAlign: "center"}} type="text" value="000,000,000 KRW"></input>
              </Input_box>
						</div>
					</li>
          <li>
						<strong>금월 입금 금액</strong>
						<div>
              <Input_box>
                <input style={{textAlign: "center"}} type="text" value="000,000,000 KRW"></input>
              </Input_box>
